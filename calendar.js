document.getElementById('bg-task').addEventListener("click", hide);
    ...
    function blockAll(element){
      let elements = ["a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","r","s","t","u","w","x","y","z"];
    ...
    function a() {
      ...
      if (GivenDate > CurrentDate) {
        alert(" Don't be so impatient! This window will open soon.");
      }
      else {
        blockAll("a");
      }
